...
def main():
    ...
    title_html = f"<h1 align=\"center\">AI助手 {get_current_version()}</h1>{theme_declaration}"
    ...
    customize_btns = {}
    predefined_btns = {}
    with gr.Blocks(title="AI助手", theme=set_theme, analytics_enabled=False, css=advanced_css) as demo:
        gr.HTML(title_html)
